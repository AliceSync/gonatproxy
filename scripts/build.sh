...
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -trimpath -ldflags="$LDF" -o bin/deepseek-server_linux_arm64 ./cmd/server
...
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -trimpath -ldflags="$LDF" -o bin/deepseek-client_linux_arm64 ./cmd/client
echo "building natclient..."
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -trimpath -ldflags="$LDF" -o bin/deepseek-natclient_linux_amd64 ./cmd/natclient
